 ...
 *
 * All 13 words stacked vertically. The stack translates up as you scroll.
 * Whichever word is centered gets `active=true` and CSS pops it
 * (white + bigger + glow). No CSS variables, no per-frame style writes.
 *
 * Behind the words: a flowing vector-field particle animation (canvas).
 */
